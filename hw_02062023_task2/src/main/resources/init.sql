...
DROP TABLE IF EXISTS 02062023_task2_categories;
CREATE TABLE 02062023_task2_categories(id INT PRIMARY KEY NOT NULL AUTO_INCREMENT, name VARCHAR(45),
 imagepath VARCHAR(45), sometext VARCHAR(45));
INSERT INTO 02062023_task2_categories(name, imagepath, sometext)
VALUES
    ('Strategies','images/strategies.jpg','High rated strategies'),
    ('Shooters','images/shooters.jpeg','Best online shooters');

DROP TABLE IF EXISTS 02062023_task2_products;
CREATE TABLE 02062023_task2_products(id INT PRIMARY KEY NOT NULL AUTO_INCREMENT, name VARCHAR(45),
                                       imagepath VARCHAR(45), description TEXT, categoryid INT);
INSERT INTO 02062023_task2_products(name, imagepath, description, categoryid)
VALUES
...
DROP TABLE IF EXISTS 02062023_task2_users;
CREATE TABLE 02062023_task2_users(id INT PRIMARY KEY NOT NULL AUTO_INCREMENT, login VARCHAR(45),
                                       password VARCHAR(45), name VARCHAR(45), surname VARCHAR(45), balance VARCHAR(45));
INSERT INTO 02062023_task2_users(login, password, name, surname, balance)
VALUES
